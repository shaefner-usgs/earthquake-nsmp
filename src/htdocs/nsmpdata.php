...
<p>Processed strong-motion records of engineering interest are available at the <a href="https://strongmotioncenter.org/">Center for Engineering Strong Motion Data</a> (CESMD), a cooperative effort between the USGS and the California Geological Survey. The software <a href="https://www.usgs.gov/node/279400">PRISM</a> is used to process all strong motion records processed by the USGS NSMP.</p>
...
<p><a href="https://www.ncedc.org/ftp/pub/doc/NP.info/">Station metadata</a> describing the coordinates, instrument response, and epochs of operation for all equipment operated by the NSMP is available from the Northern California Earthquake Data Center.</p>
